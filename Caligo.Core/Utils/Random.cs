...
// The +1 ensures NextDouble doesn't generate 1.0
    ...
    public void NextBytes(byte[] buffer)
    {
        ...
        for (var bound = buffer.Length - 3; i < bound;)
        {
            ...
            // casting because the cast ignores those bytes. Thanks to Stefan Trosch�tz for pointing this out.
            t = x ^ x << 11;
            x = y;
            y = z;
            z = w;
    ...
    /// <summary>
    /// Generates an uint. Values returned are over the full range of a uint, 
