...
public static class Easings
{
    ...
    /// </code>
    /// </summary>
    public static float EaseInOutCirc(float t) => t < 0.5f ? (1 - MathF.Sqrt(1 - MathF.Pow(2 * t, 2))) / 2 : (MathF.Sqrt(1 - MathF.Pow(-2 * t + 2, 2)) + 1) / 2;
    ...
    /// </code>
    /// </summary>
    public static float EaseInBack(float t, float s = 1.70158f) => s * t * t * t - s * t * t;
    ...
    /// </code>
    /// </summary>
    public static float EaseOutBack(float t, float s = 1.70158f) => 1 + s * MathF.Pow(t - 1, 3) + s * MathF.Pow(t - 1, 2);
    ...
    /// </code>
    /// </summary>
    public static float EaseInOutBack(float t, float s = 1.70158f) => t < 0.5f ? (MathF.Pow(2 * t, 2) * ((s * 1.525f + 1) * 2 * t - s * 1.525f)) / 2 : (MathF.Pow(2 * t - 2, 2) * ((s * 1.525f + 1) * (t * 2 - 2) + s * 1.525f) + 2) / 2;
}