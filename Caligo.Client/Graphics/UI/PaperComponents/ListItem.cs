...
{
    public static ElementBuilder ListItem(string text, bool selected = false, Action<ClickEvent>? onClick = null,
        char? icon = null)
    {
        ...
        using (parent.Enter())
        {
            ...
            if (icon is not null) Icon(icon.Value, 16).TextColor(Style.TextColor);
