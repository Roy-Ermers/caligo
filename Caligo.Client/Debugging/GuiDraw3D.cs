...
public static class Gizmo3D
{
    ...
    public static void DrawBoundingBox(BoundingBox boundingBox, Color color = default)
    {
        ...
        // Bottom face
        DrawCalls.Push(new LineSegment(new Vector3(min.X, min.Y, min.Z), new Vector3(max.X, min.Y, min.Z), finalColor));
        DrawCalls.Push(new LineSegment(new Vector3(max.X, min.Y, min.Z), new Vector3(max.X, min.Y, max.Z), finalColor));
        DrawCalls.Push(new LineSegment(new Vector3(max.X, min.Y, max.Z), new Vector3(min.X, min.Y, max.Z), finalColor));
        DrawCalls.Push(new LineSegment(new Vector3(min.X, min.Y, max.Z), new Vector3(min.X, min.Y, min.Z), finalColor));

        // Top face
        DrawCalls.Push(new LineSegment(new Vector3(min.X, max.Y, min.Z), new Vector3(max.X, max.Y, min.Z), finalColor));
        DrawCalls.Push(new LineSegment(new Vector3(max.X, max.Y, min.Z), new Vector3(max.X, max.Y, max.Z), finalColor));
        DrawCalls.Push(new LineSegment(new Vector3(max.X, max.Y, max.Z), new Vector3(min.X, max.Y, max.Z), finalColor));
        DrawCalls.Push(new LineSegment(new Vector3(min.X, max.Y, max.Z), new Vector3(min.X, max.Y, min.Z), finalColor));

        // Vertical edges
        DrawCalls.Push(new LineSegment(new Vector3(min.X, min.Y, min.Z), new Vector3(min.X, max.Y, min.Z), finalColor));
        DrawCalls.Push(new LineSegment(new Vector3(max.X, min.Y, min.Z), new Vector3(max.X, max.Y, min.Z), finalColor));
        DrawCalls.Push(new LineSegment(new Vector3(max.X, min.Y, max.Z), new Vector3(max.X, max.Y, max.Z), finalColor));
        DrawCalls.Push(new LineSegment(new Vector3(min.X, min.Y, max.Z), new Vector3(min.X, max.Y, max.Z), finalColor));
    }
