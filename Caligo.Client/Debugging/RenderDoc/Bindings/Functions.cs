...
namespace Caligo.Client.Debugging.RenderDoc.Bindings;
...
/// </summary>
public delegate int pRENDERDOC_SetCaptureOptionU32(
    RENDERDOC_CaptureOption opt,
    uint val);

public delegate int pRENDERDOC_SetCaptureOptionF32(
    RENDERDOC_CaptureOption opt,
    float val);
...
/// </summary>
public delegate uint pRENDERDOC_GetCaptureOptionU32(
    RENDERDOC_CaptureOption opt);
...
/// </summary>
public delegate float pRENDERDOC_GetCaptureOptionF32(
    RENDERDOC_CaptureOption opt);
...
///     or mask
/// </summary>
public delegate void pRENDERDOC_MaskOverlayBits(
    uint And,
    uint Or);
...
/// </summary>
public delegate void pRENDERDOC_SetCaptureFilePathTemplate(
...
/// </summary>
public delegate void pRENDERDOC_SetCaptureFileComments(
...
/// </summary>
public delegate uint pRENDERDOC_LaunchReplayUI(
...
/// </summary>
public delegate void pRENDERDOC_SetActiveWindow(
    IntPtr device,
    IntPtr wndHandle);
...
/// </summary>
public delegate void pRENDERDOC_TriggerMultiFrameCapture(
    uint numFrames);
...
/// </summary>
public delegate void pRENDERDOC_StartFrameCapture(
    IntPtr device,
    IntPtr wndHandle);
...
/// </summary>
public delegate uint pRENDERDOC_EndFrameCapture(
    IntPtr device,
    IntPtr wndHandle);
...
///     was in progress
/// </summary>
public delegate uint pRENDERDOC_DiscardFrameCapture(
    IntPtr device,
    IntPtr wndHandle);
...
/// </summary>
public delegate void pRENDERDOC_SetCaptureTitle(
