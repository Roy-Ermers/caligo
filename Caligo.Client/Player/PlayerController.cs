...
public class PlayerController
{
    ...
    private float SprintMultiplier { get; set; } = 2.0f;
    private float JumpForce { get; set; } = 8.0f;
    private float Gravity { get; set; } = 20.0f;
    private float TerminalVelocity { get; set; } = 50.0f;
    private float MouseSensitivity { get; set; } = 0.002f;
    ...
    private float ResolveAxis(Vector3 currentPos, Vector3 targetPos, int axis)
    {
        ...
        if (CheckCollision(testPos))
        {
            switch (axis)
            {
                ...
                case 0:
                    _velocity.X = 0; return currentPos.X;
                case 1:
                    _velocity.Y = 0; return currentPos.Y;
                default:
                    _velocity.Z = 0; return currentPos.Z;
            }
        }
